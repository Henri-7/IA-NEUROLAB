...
const FRIENDLY_API_MESSAGES: Record<string, string> = {
  ...
  AI_RATE_LIMITED: 'O limite temporário da assistente foi atingido. Tente novamente em alguns instantes.',
  AI_TIMEOUT: 'A assistente demorou mais do que o esperado para responder. Tente novamente.',
  AI_PROVIDER_UNAVAILABLE: 'A assistente está temporariamente indisponível.',
  AI_RESPONSE_INVALID: 'A assistente retornou uma resposta inválida. Tente novamente.',
